                ...
                <div class="row" style="flex-flow: inherit;">
                    ...
                    <div class="card mb-3" id="form" style="width: 100%">
                        <div class="card-header">
                            ...
                            Select an interest to be removed.</div>
                        <div class="card-body">
                                <form action='<%=request.getContextPath()%>/account/RemoveInterest' method='post' class="my-modal-content">
                                <div class="columnTwoThird container">
                                    ...
                                    <div class="centeredDiv2">
                                        <button type="submit" class="submit-button-half">Remove</button>
                                    </div>
                                </div>
                            </form>
                        </div>
